...
// import {OnlineServices, PaymentRequest, OnlineTransaction} from 'empiria-land/online.services';
...
export class GetPaymentDataCmp {
    // public paymentRequest: PaymentRequest = this.getNewPendingNoteRequest();
